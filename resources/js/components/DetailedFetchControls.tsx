...
function DetailedFetchControls({ item, limitList, setLimit }: Props) {
    return (
        <div className="flex gap-4">
            <div className="font-bold w-2/5">Last detailed fetch date {item.last_detailed_fetch ? <TimeAgo datetime={item.last_detailed_fetch} locale='en' /> : 'never'}</div>
...
export default DetailedFetchControls